...
line1 = adafruit_display_text.label.Label(
    ...
    color=0x0066FF,
    text="Mechanical Advantage Littleton Robotics")
...
line2 = adafruit_display_text.label.Label(
    font=terminalio.FONT,
    color=0xFBFF00,
    text="Zoll Intuitive Foundation, NASA, ETM Manufacturing, Rockwell Automation, Patriot Beverages, Tuck & Tuck Architects, Workers Credit Union, The Mighty OAK Fund, UML ARC, PTC, Millipore Sigma, Miller Family, Bruce & Sue Bonner, Tari Radin")
